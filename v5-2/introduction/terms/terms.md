...
_СУБД выгрузки данных_ — СУБД, из которой выгружаются данные системы. СУБД выгрузки данных указывается 
в запросе или определяется системой на основе следующих факторов: параметров запроса, месторасположения данных и 
